...
namespace GBIplantRESTapi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IGBIingridientService, GBIingridientsServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IExecutorService, ExecutorServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IGBIpieceOfArtService, GBIpieceOfArtServiceDB>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IReportingService, ReportingServiceBD>(new HierarchicalLifetimeManager());
